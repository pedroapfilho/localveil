...
const pt: Messages = {
  ...
  "models.busy": "Dá para trocar quando os arquivos em andamento terminarem.",
  "models.description":
    "A detecção roda neste aparelho. Cada modelo é baixado uma vez e fica neste navegador.",
  ...
  "models.removed": "{name} foi removido deste navegador.",
  "models.removeFailed": "Não foi possível remover {name}.",
  "models.status.absent": "Não baixado · {size}",
