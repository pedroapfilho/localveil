...
const es: Messages = {
  ...
  "dropzone.files": "Elegir archivos",
  "dropzone.folder": "Elegir una carpeta",
  "dropzone.formats": "Archivos de texto, Markdown, CSV, JSON, log, PDF e imagen",
  "dropzone.hint": "o arrástralos aquí",
  "dropzone.label": "Agregar archivos o carpetas",
  ...
  "label.account_number": "Número de cuenta",
  "label.private_address": "Dirección",
  "label.private_date": "Fecha",
  "label.private_email": "Correo",
  "label.private_person": "Nombre",
  "label.private_phone": "Teléfono",
  "label.private_url": "Enlace",
  "label.secret": "Secreto",
  ...
  "models.busy": "Podrás cambiarlo cuando terminen los archivos en curso.",
  "models.description":
    "La detección se ejecuta en este dispositivo. Cada modelo se descarga una vez y queda en este navegador.",
  ...
  "models.removed": "{name} se quitó de este navegador.",
  "models.removeFailed": "No se pudo quitar {name}.",
  "models.status.absent": "Sin descargar · {size}",
  ...
  "status.reviewing": "Listo para revisar",
  ...
  "toast.fileLimit": "Solo se agregaron los primeros {count} archivos.",
  "toast.folderFailed": "No se pudo leer esa carpeta.",
